...
\section{サンプリング周期の変更による制御性能評価}
	離散化を行うサンプリング周期$\Delta$を変更することで倒立振子の安定化制御の性能を高めることができる。
...
\section{振り上げ制御及び安定化に対する制御性能評価}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.49\linewidth]{gazo/Hsimu_R.eps}
		\includegraphics[width=0.49\linewidth]{gazo/Hsimu_TH.eps}
	...
	左図より、台車の位置に関しては$k$の値によって若干の差異が確認できるが、有意な違いは出ていない。右図より、振子の角度に関しては$k$の値による差異はほとんど確認できない。
